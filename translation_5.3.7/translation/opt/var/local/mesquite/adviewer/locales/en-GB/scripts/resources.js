...
To complete your AmazonLocal order, connect to a wireless network within the next {purchaseDaysRemaining} days. We will send a voucher to Home and a notification to your e-mail account once your order has processed. The voucher will contain instructions on how to redeem this offer.	Aby dokończyć zamówienie w AmazonLocal, połącz się z siecią bezprzewodową w ciągu następnych {purchaseDaysRemaining} dni. W czasie gdy zamówienie będzie przetwarzane, na ekran główny wyślemy Ci voucher. Instrukcję jak z niego możesz skorzystać otrzymasz e-mailem.
View All Special Offers	Zobacz wszystkie oferty specjane
