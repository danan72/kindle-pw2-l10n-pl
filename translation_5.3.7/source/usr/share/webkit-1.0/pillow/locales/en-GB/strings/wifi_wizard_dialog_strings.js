...
Your Kindle is unable to connect to the Wi-Fi network "{essid}" using WPS. Would you like to manually set up this network?	
Your Kindle is unable to connect to the Wi-Fi network "{essid}". --"{error}"--. Press Set Up to enter your password again or manually set up your network. If you have issues connecting your Kindle to Wi-Fi, you can find help at www.kindle.com/support.	
...
Your Kindle is unable to connect to the Wi-Fi network "{essid}". Press Set Up to enter your password again or manually set up your network. If you have issues connecting your Kindle to Wi-Fi, you can find help at www.kindle.com/support.	
...
Your Kindle is unable to connect to the Wi-Fi network "{essid}". The access point rejected the connection request. Check your router\'s MAC address filtering settings and try again.	
Your Kindle is unable to connect to the Wi-Fi network "{essid}". The network name is too long. Would you like to manually set up this network?	
Your Kindle is unable to connect to the Wi-Fi network "{essid}". The password you entered is incorrect. Try entering your password again or manually setting up your network. If you have issues connecting your Kindle to Wi-Fi, you can find help at www.kindle.com/support.	
